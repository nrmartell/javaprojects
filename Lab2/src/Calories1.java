...
import java.util.Scanner;
	...
	public class Calories1 {
	    ...
	    public static void readFile()  {
	        ...
	        int n = 3;
	        //  Number of rows will be 7, columns will be n.
	    ...
	    public static void checkArraySize(int[][] weeklyCalories){
	    	for (int i = 0; i < weeklyCalories[0].length; i++) {
	    		...
	    		for (int j = 0; j < weeklyCalories.length; j++){
	    			...
	    			if(weeklyCalories.length < 3 || weeklyCalories[0].length < 7){
	    ...
	    public static void checkArrayAllIntegers(int[][] weeklyCalories){

	    
	    }
	    
	    public static void checkArrayForNullValues(int[][] weeklyCalories){
